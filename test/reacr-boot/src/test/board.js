...
function board() {
    ...
    const Data1 = useFetch("http://localhost:5030/board")
    let [cocktail, setCocktail] = useState(Data1)
        ...
        <>
            ...
            */}
            ...
            <div className='d-flex justify-content-center mt-1'>
                <button onClick={()=>setCocktail(Data1)} className='defaultButton mx-3'>전체</button>
                <button onClick={()=>setCocktail(Data1.filter(x=>x.category === '자유'))} className=' mx-3'>자유</button>
                <button onClick={()=>setCocktail(Data1.filter(x=>x.category === 'Q&A'))} className=' mx-3'>Q&A</button>
            </div>
